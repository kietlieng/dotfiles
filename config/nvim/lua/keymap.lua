...
map("n", "<LEADER>l", 'ml0vg_y<CR>`l', G_SILENT_NO_REMAP)                             -- copy current line to clipboard without newline
...
map("n", "<LEADER>JJ", "<cmd>lua require('custom/fzf').readJumpFiles()<CR>", G_SILENT_NO_REMAP)     -- search from git root
