...
function F.setup()
  ...
  map( "n", "<LEADER>CC", ":lua require('comments').comments(true, true, false)<CR>", G_SILENT_NO_REMAP )    -- global comment
  map( "n", "<LEADER>CU", ":lua require('comments').comments(true, false, false)<CR>", G_SILENT_NO_REMAP )   -- glubal uncomment
  map( "n", "<LEADER>cc", ":lua require('comments').comments(false, true, false)<CR>", G_SILENT_NO_REMAP )   -- block comment
  map( "n", "<LEADER>cu", ":lua require('comments').comments(false, false, false)<CR>", G_SILENT_NO_REMAP )  -- block uncomment
  map( "v", "<LEADER>CC", ":lua require('comments').comments(true, true, true)<CR>", G_SILENT_NO_REMAP )     -- global comment invert
