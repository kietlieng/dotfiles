...
function display() {
    ...
    print "<svg version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' width='500' height='500' viewBox='-700 -700 1400 1400'>"
...
#    # needs work cause it's complicated
    subtext_grid[5,0] = -1
    subtext_grid[5,1] = -1
    subtext_grid[5,2] = 1
    subtext_grid[5,3] = -1
...
NR == 4 {
    ...
    while (textIndex < NF) {
        ...
        if ($textIndex != "_") {
            text_array[countIndex] = drawText(subtext_grid[CIRCLE_COUNT, textYIndex], subtext_grid[CIRCLE_COUNT, (textYIndex + 1)], tSide, $(textIndex + 1), "false")
        }
        textIndex++
        countIndex++
   }
