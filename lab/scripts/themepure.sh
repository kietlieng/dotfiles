...
#' ⟭ᕲৡࡇ -⨊ ' # r-type
#'██▇(〇⪧ᐊ〇)' '██▇(〇⪧ᐊ〇)' '██▇( ⪧ᐊ)' '██▇▄  ⪧' '██▇▄   ' '██▇▄▁  ⪧ ' '██▇▄▁  ⪧︺⦅ ' 
#'█▄▁  ⪧乛𐌂' '█▄▁  ⪧ 󰥽 ' '█▄▁  ⪧乛󰨂 󰽧' '█▄▁  ⪧︺󱫯 󰽧' '█▄▁  l⪧︺󱫯 󰽧' '██▇▄( 𐪕︶󱫯 󰽧' '██▇▄( ︶󱫯 )' Tron lightcycle
#'██▇▄( ︶󱫯 ' Tron lightcycle
#'██▇▄ ︶󱫯 ' Tron lightcycle
...
#'𐿉⦅ 𒐴 ' '⛷⦅ 𒑩 ' '⛷⦅ O𐠛 ' '⛷⦅ ㇣𐠛 ' '⛷⦅ ㈇𐠛 ' '⛷⦅ ꔌ𐠛 ' '⛷⦅  𐠛 ' '⛷⦅ 𐠛 ' 
#'⛷⦅  𐠛 ' '⛷⦅  𐠛 ' '⛷⦅  𐠛 ' '⛷⦅  𐠛 ' '⛷⦅  𐠛 ' '⛷⦅  𐠛 ' '⛷⦅  𐠛 ' '⛷⦅ 𢡊𐠛 '
#'⛷⦅ 﫜𐠛 ' '⛷⦅ 𐒆𐠛 ' '⛷⦅ 𐔖𐠛 ' '⛷⦅ 𐙝𐠛 ' '⛷⦅ 𐙟𐠛 ' '⛷⦅ 𐞵𐠛 ' '⛷⦅ 𖩀𐠛 ' '⛷⦅ 𖩃𐠛 ' '⛷⦅ 𖩗𐠛 ' 
#'⛷⦅ 𖫩𐠛 ' '⛷⦅ 𞋰𐠛 ' '⛷⦅ 𞠧𐠛 ' '⛷⦅ 🄎 𐠛 ' '⛷⦅ 󰍚 𐠛 ' '⛷⦅ 󰍷 𐠛 ' '⛷⦅ 󰓏 𐠛 ' '⛷⦅ 󰜞 𐠛 '
#'⛷⦅ 󰣉 𐠛 ' '⛷⦅ 󱋨 𐠛 ' '⛷⦅ 󱑌 𐠛 ' '⛷⦅ 󱞈 𐠛 ' '⛷⦅ 󱡊 𐠛 ' '⛷⦅ 󱤌 𐠛 ' '⛷⦅ 󱤹 𐠛 ' '⛷⦅ 󱤹 𐠛 '
#'⛷⦅ 󱥸 𐠛 ' '⛷⦅ 󱨅 𐠛 ' '⛷⦅ 󱨅 𐠛 ' '⛷⦅  𐠛 ' '⛷⦅  𐠛 ' '⛷⦅ 𝧿 𝨀𐠛 ' '⛷⦅ 〇𐠛 ' '⛷⦅  𐠛 '
#'⛷⦅  𐠛 ' '⛷⦅ 󰏝 𐠛 ' '⛷⦅ 󰀚 𐠛 ' '⛷∡ 󰋷 𐠛 ' '⛷∡ 󱢖 𐠛 ' '⛷∡  𐠛 ' '⛷∡ 󰀚 𐠛 ' # angler fish
#'⛷∡  𐠛 ' # angler fish
#'⛷∡  𐝆 ' # angler fish
#'⛷∡  𑋸 ' # angler fish
#'⛷∡  󰥽  ' # angler fish
...
# 'ᚁᚂᚅᚋᚌᚏ业ᚏᚌᚋᚅᚂᚁ' game of thrones

#KL_STATUS_SYMBOL_ARRAY=('⛷∡  𐠛 ')
KL_STATUS_SYMBOL_ARRAY=('⛷∡  𐠛 ' '   ' '🭇🬛' '𝍣' '|' '   ' '󰇆' '(⌐󱪶 Ⲻ󱪶 )' '/l- -l' '(⌐〇_〇)' '⟦ ⟧) 9K?!' '󰹫 -𝧿 ' '[+..••]' "<(-''-)>" '𐤔ᜠᜰ_ᯓࡄ ' ' ⦿๏ ᯓ㋨' '󱆨󰗣󱆨' '♠ ♥ ♦ ♣' '█▄▄▀█▄▀▀▀▀▄█▄ ██' '⭣⭨ ⭢ Ⓗ   ' '⮅ ⮇ ⭾ ⭾ Ⓑ Ⓐ ' '󰡗 󰡘 󰡙 󰡚 󰡛 󰡜' '󱙜 󰧵 ᯓ󰮯 ●ᯓ󱙝 ᯓ󰊠 ' '󱠡   ' '󱃏 󰓥    ' 'ᯓ〛ⱃ⳻)' '▂▄▆█ ᛩ ▗▆▖' ' ⟭ᕲৡࡇ -𒊹𖣇' '██▇▄ ︶󱫯 ')
