...
#' ⟭ᕲৡࡇ -𒊹𖣇' # r-type
#'██▇(〇⪧ᐊ〇)' '██▇(〇⪧ᐊ〇)' '██▇( ⪧ᐊ)' '██▇▄  ⪧' '██▇▄   ' '██▇▄▁  ⪧ ' '██▇▄▁  ⪧︺⦅ ' 
#'█▄▁  ⪧乛𐌂' '█▄▁  ⪧ 󰥽 ' Tron lightcycle
#'█▄▁  ⪧乛󰨂 󰽧 ' Tron lightcycle
#'█▄▁  ⪧︺󱫯 󰽧 ' Tron lightcycle
#'█▄▁  l⪧︺󱫯 󰽧 ' Tron lightcycle
#'██▇▄( 𐪕︶󱫯 󰽧 ' Tron lightcycle
...
#KL_STATUS_SYMBOL_ARRAY=('   ' '܋𑇧܋' '🭇🬛' '𛰙𝍣𛰚' '|' '   ' '󰇆' '(⌐󱪶 Ⲻ󱪶 )' '/l- -l' '(⌐〇_〇)' '⟦ ⟧) 9K?!' '(󰹞󰹞-󰽤 )' '[+..••]' "<(-''-)>" '𐤔ᜠᜰ_ᯓࡄ ' ' ⦿๏ ᯓ㋨' '󱆨󰗣󱆨' '♠ ♥ ♦ ♣' '█▄▄▀█▄▀▀▀▀▄█▄ ██' '⭣⭨ ⭢ Ⓗ   ' '⮅ ⮇ ⭾ ⭾ Ⓑ Ⓐ ' '󰡗 󰡘 󰡙 󰡚 󰡛 󰡜' '󱙜 󰧵 ᯓ󰮯 ●ᯓ󱙝 ᯓ󰊠 ' '󱠡   ' '󱃏 󰓥    ' 'ᯓ〛ⱃ⳻)' '▂▄▆█ ᛩ ▗▆▖' ' ⟭ᕲৡࡇ -𒊹𖣇' '██▇▄( 𐪕︶󱫯 󰽧 ')
KL_STATUS_SYMBOL_ARRAY=('   ' '🭇🬛' '𛰙𝍣𛰚' '|' '   ' '󰇆' '(⌐󱪶 Ⲻ󱪶 )' '/l- -l' '(⌐〇_〇)' '⟦ ⟧) 9K?!' '(󰹫 -𝧿 )' '[+..••]' "<(-''-)>" '𐤔ᜠᜰ_ᯓࡄ ' ' ⦿๏ ᯓ㋨' '󱆨󰗣󱆨' '♠ ♥ ♦ ♣' '█▄▄▀█▄▀▀▀▀▄█▄ ██' '⭣⭨ ⭢ Ⓗ   ' '⮅ ⮇ ⭾ ⭾ Ⓑ Ⓐ ' '󰡗 󰡘 󰡙 󰡚 󰡛 󰡜' '󱙜 󰧵 ᯓ󰮯 ●ᯓ󱙝 ᯓ󰊠 ' '󱠡   ' '󱃏 󰓥    ' 'ᯓ〛ⱃ⳻)' '▂▄▆█ ᛩ ▗▆▖' ' ⟭ᕲৡࡇ -𒊹𖣇' '██▇▄( 𐪕︶󱫯 󰽧 ')
