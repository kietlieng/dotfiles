...
KL_STATUS_SYMBOL_ARRAY=('󰜎  ' '🫸󰋦 🫷' ' 󱅻  ' ' 󱅻  ' ' 󱅻  ' ' 󱅻  ' '󱌆 󱆊 ' ' 󱅻  ' '󰭥 󱩁 ' '󱅼 🯁🯂🯃' '🮲🭰🭵🮳' '꧈⭜ 󰻃 𐠛 ' '   ' '🭇🬛' '𝍣' '⦀[' '   ' '󰇆' '(⌐󱪶 Ⲻ󱪶 )' '/l- -l' '(⌐〇_〇)' '⟦ ⟧) 9000?!' '🬋🬋-𝧿 ' '[+..••]' "<(-''-)>" '𐤔ᜠᜰ_ᯓࡄ ' ' ⦿๏ ᯓ㋨' 'ଲଳ.󱆨󰗣󱆨.' '[♠][♥][♦][♣]' '█▄▄▀█▄▀▀▀▀▄█▄ ██' '⭣⭨ ⭢ Ⓗ   ' '⮅ ⮇ ⭾ ⭾ Ⓑ Ⓐ ' '󰡗 󰡘 󰡙 󰡚 󰡛 󰡜' '󱙜 󰧵 ᯓ󰮯 ●ᯓ󱙝 ᯓ󰊠 ' '󱠡   ' '󱃏 󰓥    ' 'ᯓ〛ⱃ⳻)' '▂▄▆█ ᛩ ▗▆▖' ' ⟭ᕲৡࡇ -𒊹𖣇' '██▇▄ ︺ᐊꓛ')
...
# 🖘 🖙 🖚 🖛 🖜 🖝 🖞 🖟 🖠 🖡 🖢 🖣 
#                   󱖡 
# 󰱏 󰵶 󰵷 󰹆 󰹇 󱃱 󱈘 󱈛 󱉘 󱎟 󱕾 󱕿 󱖀 󱢶 󱢷 󱥋 󱩂 󰆽 󰔑 
# 󰔒 󰔓 󰔔 󰔕 󰕹 󰜼 󰜽 󰜾 󰜿 󰝀 󰝁 󰝂 󰝃 󰩏 󰩑 󰩒 󰩓 󰩔 󰩕 
# 󰭥 󱠫 󱠬 󱠭 󱠮 󱠯 󱠰 󱠱 󱠲 󱠳 󱠡 󱠢 󰽒 ☚ ☛ ☜ ☝ ☞ ☟ 
# 󰋇 󰩐 🤌🤏🤘🤙🤚🤛🤜🤝🤞🤟🤲🥊🦵🦶🦻 
# 🫰🫱🫲🫳🫴🫵🫶🫷🫸✊✋✌✍
...
# 🮲🮳🤷🤸🤺🤼🤽🤾󰚩 󱥵   
#                󱎋 󱎌 󱎍 󱖁 
# 󱝄 󱝅 󱝆 󱟄 󱠕 󱠖 󱠣 󱢘 󱢙 󱢚 󱢛 󱦀 󱦁 󱥷 󱄛 󱅝 󱅞 󱅟 󱅻 
# 󱅼 󱌄 󱌅 󱌆 󱌇 󱌈 󱌉 󰮖 󰺛 󰽒 󰽓 󰾣 󰿖 󰿗 󰿻 󱀓 󰯩 󰲈󰳩 󰵿 
# 󰶇 󰶑 󰸔 󰹼 󰹽 󰱶 󰱷 󰱸 󰱹 󰱻 󰱨 󰱩 󰱪 󰱫 󰱬 󰱭 󰱮 󰱯 󰱰 
# 󰱱 󰱲 󰱳 󰱴 󰱵 󱨟 󱨠 󱨡 󱩲 󱪇 󱪌 󰀙 󰁬 󰂣 󰋦 󰋧 󰋨 󰐛 󰑮 
# 󰑻 󰑼 󰑽 󰑾 󰑿 󰒀 󰒁 󰒂 󰒷 󰓋 󰒶 󰓣 󰔁 󰖤 󰗋 󰗏 󰗓 󰖵 󰖃 
# 󰘰 󰘱 󰙃 󰙄 󰙉 󰙊 󰙋 󰙌 󰙍 󰚼 󰜎 󰠃 󰠨 󰠬 󰢙 󰢚 󰢯 󰩂 󰩈 
# 󰩙 󰩚 󰩛 󰩜 󰩝 󰩞 󰪭 󰫁 󰭐 󰭑 󰭒 󰭓 󱗉 󱗻 󱨟 󱨠 󱨡 󱩁 󱪌 
# 󱃞 󱃟 
