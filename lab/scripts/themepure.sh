...
# KL_STATUS_SYMBOL_ARRAY=('󿀭 󿀮 󿀯 ' '󰊠 _' '󱙝 _' '󱌆 󱆊' '󰭥 󱩁 ' '󱅼 🯁🯂🯃' '🮲🭰🭵🮳' '꧈⭜ 󰻃 𐠛 ' '   ' '🭇🬛' '⟍ 🭢🭗🭇🬼🭢🭗⟋ ' '󰇆' '(⌐󱪶 Ⲻ󱪶 )' '🭋- -🭀' '(⌐〇_〇)' '🬋-𝧿 ' '[+..••]' "<(-''-)>" '𐤔ᜠᜰ_ᯓࡄ ' 'ଲଳ.󱆨󰗣󱆨.' '󰣎 󰣏 󰣐 󰣑 ' '𜰥𜰤𜰤𜰡𜰥𜰤𜰡𜰡𜰡𜰡𜰤𜰥𜰤 𜰥𜰥' '⭣⭨ ⭢ Ⓗ   ' '⮅ ⮇ ⭾ ⭾ Ⓑ Ⓐ ' '󰡗 󰡚 󰡛 󰡜 󰡘 󰡙' '󱙜 󰧵 ᯓ󰮯 ●ᯓ󱙝 ᯓ󰊠 ' 'ᯓ〛ⱃ⳻)' '𜹠𜹤𜹥 ᛩ ⛫ ' ' ⟭ᕲৡࡇ -𒊹𖣇' '██▇▄ ︺ᐊꓛ' 'ࡄࡄࡄɅࡄ')

# game pack
KL_STATUS_SYMBOL_ARRAY=('⦿ ๏໐ᯓ㋨' '  ' '[ ][ ][ ][忍]' '󱃏  ♥ ♡ ♡' '🮲🭰🭵🮳' '[+..••]' "<(-''-)>" '𐤔ᜠᜰ_ᯓࡄ󰄰 ' 'ଲଳ.󱆨󰗣󱆨.' '󰣎 󰣏 󰣐 󰣑 ' '𜰥𜰤𜰤𜰡𜰥𜰤𜰡𜰡𜰡𜰡𜰤𜰥𜰤 𜰥𜰥' '⭣⭨ ⭢ Ⓗ   ' '⮅ ⮇ ⭾ ⭾ Ⓑ Ⓐ ' '󰡗 󰡚 󰡛 󰡜 󰡘 󰡙' '󱙜 󰧵 ᯓ󰮯 ●ᯓ󱙝 ᯓ󰊠 ' 'ᯓ〛ⱃ⳻)' '𜹠𜹤𜹥 ᛩ ⛫ ' ' ⟭ᕲৡࡇ -𒊹𖣇' '██▇▄ ︺ᐊꓛ')

# evil pack
 # KL_STATUS_SYMBOL_ARRAY=('🭇🬛' '⟍ 🭢🭗🭇🬼🭢🭗⟋ ' '   ' '󰇆 ')

# movie pack
# KL_STATUS_SYMBOL_ARRAY=('   ' '🭇🬛' '⟍ 🭢🭗🭇🬼🭢🭗⟋ ' '󰇆' '(⌐󱪶 Ⲻ󱪶 )' '🭋- -🭀' '(⌐〇_〇)' '🬋-𝧿 ' '██▇▄ ︺ᐊꓛ' 'ࡄࡄࡄɅࡄ')
