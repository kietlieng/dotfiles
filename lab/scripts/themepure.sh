...
KL_STATUS_SYMBOL_ARRAY=('🭇🬛' '┯┯┯' '|' '   ' '󰇆' '(⌐󱪶 Ⲻ󱪶 )' '/l- -l' '(⌐〇_〇)' '⟦ ⟧) 9K?!' '(󰹞󰹞-󰽤 )' '[+..••]' "<(-''-)>" '𐤔ᜠᜰ_ᯓࡄ ' ' ⦿๏ ᯓ㋨' '󱆨󰗣󱆨' '♠ ♥ ♦ ♣' '█▄▄▀█▄▀▀▀▀▄█▄ ██' '⭣⭨ ⭢ Ⓗ   ' '⮅ ⮇ ⭾ ⭾ Ⓑ Ⓐ ' '󰡗 󰡘 󰡙 󰡚 󰡛 󰡜' '󱙜 󰧵 ᯓ󰮯 ●ᯓ󱙝 ᯓ󰊠 ' '󱠡   ' '󱃏 󰓥    ' 'ᯓ〛ⱃ⳻)' '▂▄▆█ ᛩ ▗▆▖' ' ⟭ᕲৡࡇ -𒊹𖣇' '█▄▁  ⪧')
...
# ⌎⌏⌌⌍ ⎡⎤ ⎣⎦  ⚟⚞ ﴾ ﴿ ᎘
# ╚═╦═╬╗   𐀍𐀟𐁈𐂲
# noses Ո Ս ఎ  ໑ ꔽ ꗅ ꗆ 𠃑𠄌 𠄍 𠄎 𠄏 𠃌 𠦜
# 𡿜𡿦 𡿧 𡿨𡿪𣦶𠓛 𠓜 𠓝 𠓞𠘧 𠘨 𠚳𡘋𡭯𢁝𣁬𣱾
#  ⛛ ⛰ ᧘ ⊱⊰ ⍙ ⍞ ⍠ ⎆ ⥶⥸ ⫑⫒ ⫎ ⫍ ᚜᚛
# ⺡ ⌠⌡󰿈⎇ ༅ ༆ ༄ ᯢ 󰵄 ꣺⳿ ⮁ꕸ ꚜꧦኑ 𠄎
# 󱀑 󰾋 󰷝  󰫠 󱃏  
# 󱙳 󱙴 ﹏΅ 󰼁 󰼂 󰹢 󰹣  _    󰨙 󰨚
