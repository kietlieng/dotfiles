...
#KL_STATUS_SYMBOL_ARRAY=('꧈𐕕   𐠛 ')
KL_STATUS_SYMBOL_ARRAY=('꧈𐕕   𐠛 ' '   ' '🭇🬛' '𝍣' '|' '   ' '󰇆' '(⌐󱪶 Ⲻ󱪶 )' '/l- -l' '(⌐〇_〇)' '⟦ ⟧) 9K?!' '󰹫 -𝧿 ' '[+..••]' "<(-''-)>" '𐤔ᜠᜰ_ᯓࡄ ' ' ⦿๏ ᯓ㋨' '󱆨󰗣󱆨' '♠ ♥ ♦ ♣' '█▄▄▀█▄▀▀▀▀▄█▄ ██' '⭣⭨ ⭢ Ⓗ   ' '⮅ ⮇ ⭾ ⭾ Ⓑ Ⓐ ' '󰡗 󰡘 󰡙 󰡚 󰡛 󰡜' '󱙜 󰧵 ᯓ󰮯 ●ᯓ󱙝 ᯓ󰊠 ' '󱠡   ' '󱃏 󰓥    ' 'ᯓ〛ⱃ⳻)' '▂▄▆█ ᛩ ▗▆▖' ' ⟭ᕲৡࡇ -𒊹𖣇' '██▇▄ ︶󱫯 ')
