...
#    "CJK Unified Ideographs Extension G": (0x30000, 0x3134F), # useless
...
def generate_unicode_by_blocks(blocks, filename, widthsize = 50):
    """
    Generates Unicode characters for the given blocks, 
    adds a newline after every 50 characters, 
    and writes the result to a file.

    :param blocks: Dictionary of Unicode blocks with their start and end code points.
...
# Example usage:
filename = '/tmp/unicode_characters_by_block.txt'
filename_other = '/tmp/unicode_characters_by_block_other.txt'
generate_unicode_by_blocks(unicode_blocks, filename)
generate_unicode_by_blocks(unicode_blocks_other, filename_other, 30)
